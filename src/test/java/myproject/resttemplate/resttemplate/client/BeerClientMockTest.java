...
import myproject.resttemplate.resttemplate.config.OAuthClientInterceptor;
...
class BeerClientMockTest {
    ...
    public static class TestConfig {
        ...
        @Bean
        OAuthClientInterceptor interceptor(OAuth2AuthorizedClientManager manager, ClientRegistrationRepository clientRegistrationRepository) {
